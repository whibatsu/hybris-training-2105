 ...
 */
package org.training.trainingcommercewebservices.v2.config;


import de.hybris.platform.servicelayer.config.ConfigurationService;
import de.hybris.platform.webservicescommons.swagger.services.ApiVendorExtensionService;
import org.training.trainingcommercewebservices.constants.YcommercewebservicesConstants;
import org.training.trainingcommercewebservices.request.mapping.handler.CommerceHandlerMapping;
...
{
	private static final String PASSWORD_AUTHORIZATION_SCOPE = "trainingextension.oauth2.password.scope";
	private static final String CLIENT_CREDENTIAL_AUTHORIZATION_SCOPE = "trainingextension.oauth2.clientCredentials.scope";
	private static final String AUTHORIZATION_URL = "trainingextension.oauth2.tokenUrl";

	private static final String DESC = "trainingextension.v2.description";
	private static final String TITLE = "trainingextension.v2.title";
	private static final String VERSION = "trainingextension.v2.version";
	private static final String LICENSE = "trainingextension.v2.license";
	private static final String LICENSE_URL = "trainingextension.v2.license.url";
	...
	private static final String LEGACY_CONTENT_NEGOTIATION = "trainingextension.content.negotiation.legacy";
